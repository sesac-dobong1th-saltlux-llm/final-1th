...
tokenizer = SentencePieceBPETokenizer.from_file(
    vocab_filename="E:/Saltlux/최종플젝/interview_dream_server/tokenizer/vocab.json", merges_filename="E:/Saltlux/최종플젝/interview_dream_server/tokenizer/merges.txt", add_prefix_space=False
)
